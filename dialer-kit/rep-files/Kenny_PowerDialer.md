...
Body: {
  ...
  "params": [
    ...
    "assigned_to = 'Kenny Nwobi' AND opp_stage_selection = 'Missing In Action'",
...
Header: X-Claude-API-Key: claude_99efff1a004422bdb67acf3f345f8a20e4fe8c29a734a82c132b2500d9fbd4bf
Header: Content-Type: application/json
Body: { "query": "SELECT started_at, duration_minutes, total_calls, connected, interested, callbacks, ai_recap, hot_leads, follow_up_plan FROM dialer_session_logs WHERE rep_id = 'kenny' ORDER BY started_at DESC LIMIT 5" }
```
