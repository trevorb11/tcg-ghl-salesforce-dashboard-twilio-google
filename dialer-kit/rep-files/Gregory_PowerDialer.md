...
**CRITICAL: Always filter by `assigned_to = 'Greg Dergevorkian'`** — this rep can only dial their own leads. Never return leads assigned to other reps.
...
cur.execute("""
    ...
    WHERE assigned_to = 'Greg Dergevorkian'
