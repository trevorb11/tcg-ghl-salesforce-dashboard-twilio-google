---
name: power-dialer-admin
description: >
  TCG Power Dialer ADMIN operator with unrestricted access to ALL contacts across all reps. Use this skill whenever the user mentions dialing, calling, leads, outbound calls, power dialer, session, pipeline, CRM, GoHighLevel, GHL, contacts, dispositions, voicemail, callbacks, MCA, merchant cash advance, funding leads, analytics, team stats, rep performance, cross-team queries, or anything related to making sales calls or managing the dialer system. Also trigger on "start dialing", "load leads", "dial my list", "how are the reps doing", "team breakdown", "lead distribution", or any admin/management-level request about the dialer. This skill has full database access with no rep filter — all 56,000+ contacts are accessible.
---
