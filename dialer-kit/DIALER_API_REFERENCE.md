...
**IMPORTANT:** Save the `sessionId` — you need it for every subsequent call.
...
Run Claude AI analysis on a specific call. Returns summary, suggested disposition, key points, follow-up actions. Also pushes an AI-generated note to GHL.
...
```json
{
  "recap": "Strong day on the phones. You connected with 5 leads and had 3 productive conversations...",
